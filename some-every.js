...
const mixedNumbers = [ 0, 4, 3, 9, 7, 6, 4 ];
...
*/
const dogs = [ { name: 'Chief', breed: 'mixed', age: '3' }, { name: 'Poppy', breed: 'lab', age: '3', isCrazy: 'yes' } ];
...
/*
Write a function called hasCertainValue which accepts an array of objects, a key, and a value,
